      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 space-y-6 xl:col-span-8">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 md:grid-cols-5 md:gap-6">
            ...
            <Link to={'/all_plants'} className="card rounded-2xl border border-base-200 bg-base-100 p-5 md:p-6 shadow-sm">
              <div className="flex items-center justify-center w-12 h-12 bg-base-200 rounded-xl">
                <FiGrid className="text-base-content" />
              </div>
              <div className="flex items-end justify-between mt-5">
                <div>
                  <span className="text-sm text-base-content/70">Total Items</span>
                  <h4 className="mt-2 font-bold text-base-content text-3xl">
            ...
            <Link to={'/my_plants'} className="card rounded-2xl border border-base-200 bg-base-100 p-5 md:p-6 shadow-sm">
              <div className="flex items-center justify-center w-12 h-12 bg-base-200 rounded-xl">
          ...
          <div className="card overflow-hidden rounded-2xl border border-base-200 bg-base-100 px-5 pt-5 sm:px-6 sm:pt-6 shadow-sm mt-6">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold text-base-content">Monthly Sales</h3>
            ...
            <div className="max-w-full overflow-x-auto custom-scrollbar">
              <div style={{ minHeight: '195px', minWidth: '650px' }} className="w-full h-48">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={salesData} margin={{ top: 20, right: 10, left: 0, bottom: 5 }}>
                    ...
                    />
                    <Bar dataKey="sales" fill="#465FFF" barSize={10} radius={[4, 4, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </div>
        ...
        <div className="col-span-12 space-y-6 xl:col-span-4">
          <div className="card rounded-2xl border border-base-200 bg-base-100 p-5 md:p-6 shadow-sm">
            <h3 className="text-lg font-semibold text-base-content">Recent Activities</h3>
          ...
          <div className="card rounded-2xl border border-base-200 bg-base-100 p-5 md:p-6 shadow-sm">
            <div className="flex justify-between items-start mb-4">
              <div>
                <h3 className="text-lg font-semibold text-base-content">Monthly Target</h3>
                <p className="mt-1 text-base-content/70 text-sm">Target you’ve set for each month</p>
              </div>
              ...
              <div className="max-h-[330px]">
                <ResponsiveContainer width="100%" height={158}>
                  ...
                  >
                    ...
                    <RadialBar background dataKey="uv" cornerRadius={10} fill="#465FFF" clockwise />
                    <text
                      x="50%"
                      y="50%"
                      textAnchor="middle"
                    ...
                    >
                      <tspan>
                        <CountUp end={75.55} duration={2.5} decimals={2} suffix="%" />
                      </tspan>
                    </text>
                  </RadialBarChart>
                </ResponsiveContainer>
